...
| **Language** | `C++ (17)` |
| **Problem Link** | [🔗 Challenge Link](https://www.geeksforgeeks.org/problems/unoccupied-computers-1646661078/1) |
...
### Constraints:
1 ≤ n ≤ 261 ≤ |s| ≤ 52s consists of uppercase English letters and each letter occurs exactly 2 times.
